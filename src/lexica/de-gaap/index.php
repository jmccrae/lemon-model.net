...
?>
   <h1>German Generally Accepted Accounting Principles</h1>
   <a href="lexicon.en.html">English Lexicon</a><br/>
   <a href="lexicon.de.html">German Lexicon</a>
<?php
...
$prefix = "http://lemon-model/net/lexica/de-gaap";
